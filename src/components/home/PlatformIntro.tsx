...
export default function PlatformIntro() {
  ...
  function skip() {
    try {
      sessionStorage.setItem('gi-v8', '1');
    } catch (_e) {
      /* */
    }
    setActive(false);
    ...
    <>
      ...
      <div
        style={{
          ...
          zIndex: 9999,
          background: '#030306',
          animation: `piOut ${TOTAL}s ease forwards`,
        }}
        onClick={skip}
      >
        {/* Letterbox */}
        ...
        <div className="pi-s" style={{ animationDelay: `${5 * SCENE_DUR}s` }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.4)', marginTop: 24 }}>
        ...
        >
          <div
            style={{
              ...
              animation: `piBar ${TOTAL}s linear forwards`,
            }}
          />
        </div>
      </div>
