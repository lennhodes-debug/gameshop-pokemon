...
const trustItems = [
  ...
  },
  {
    ...
    title: 'Gedetailleerde beschrijving',
    subtitle: 'Conditie altijd vermeld',
  },
  {
    icon: (
      <svg
...
export default function TrustStrip() {
  return (
    <section className="bg-[#f8fafc]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-8 py-10 sm:py-12 md:py-14 lg:py-16">
        <motion.div
          initial={{ opacity: 0 }}
