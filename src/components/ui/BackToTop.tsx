    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-20 left-4 sm:bottom-6 sm:left-6 z-50 h-12 w-12 rounded-2xl bg-white/90 backdrop-blur-lg border border-slate-200 shadow-lg shadow-slate-200/50 flex items-center justify-center text-slate-600 hover:text-emerald-600 hover:border-emerald-200 hover:shadow-emerald-100/50 transition-colors"
        >
