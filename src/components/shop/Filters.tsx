    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <select
          ...
          className="rounded-xl bg-slate-50 px-3 py-2 text-xs font-medium text-slate-700 focus:ring-2 focus:ring-slate-400/20 focus:outline-none transition-all appearance-none pr-8 hover:bg-slate-100"
        >
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="flex items-center gap-2 text-xs font-medium text-slate-500 hover:text-slate-700 transition-colors px-3 py-2 rounded-xl bg-slate-50 hover:bg-slate-100"
      >
        <svg
      ...
      <AnimatePresence>
        {activeCount > 0 && (
          <motion.button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium text-red-500 bg-red-50 hover:bg-red-100 transition-colors"
          >
