...
function PillGroup({
  ...
  return (
    <fieldset>
      <legend className="block text-xs font-medium text-slate-500 mb-2 tracking-wide uppercase">{label}</legend>
        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={cn(
                'relative px-3.5 py-2 rounded-xl text-xs font-medium transition-all duration-200 overflow-hidden',
                isActive
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <select
          ...
          className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-medium text-slate-700 focus:border-slate-400 focus:ring-2 focus:ring-slate-400/20 focus:outline-none transition-all appearance-none pr-8 hover:border-slate-300"
        >
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="flex items-center gap-2 text-xs font-medium text-slate-500 hover:text-slate-700 transition-colors px-3 py-2 rounded-xl bg-slate-50 border border-slate-200"
      >
        <svg
        ...
        {activeCount > 0 && (
          <span className="h-5 w-5 rounded-full bg-slate-900 text-white text-[10px] font-medium flex items-center justify-center">
            {activeCount}
          </span>
        )}
      </button>
      ...
      <AnimatePresence>
        {activeCount > 0 && (
          <motion.button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium text-red-500 bg-red-50 border border-red-100 hover:bg-red-100 transition-colors"
          >
