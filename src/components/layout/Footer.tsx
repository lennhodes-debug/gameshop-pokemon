      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-4"
          >
            {/* Marktplaats reviews highlight */}
            <a href="https://www.marktplaats.nl/u/gameshop-enter/100074714/" target="_blank" rel="noopener noreferrer" className="block mb-6 p-4 rounded-xl bg-white/[0.04] border border-emerald-500/10 hover:border-emerald-500/20 transition-colors group">
