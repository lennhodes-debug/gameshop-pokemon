    ...
    <div className="pt-16 lg:pt-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="animate-fade-up space-y-8">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Welke gegevens verzamelen wij?</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Waarvoor gebruiken wij je gegevens?</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Verwerkers en diensten van derden</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Bewaartermijn</h2>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Je rechten</h2>
            <p className="text-slate-600 leading-relaxed">
