    ...
    <div className="pt-16 lg:pt-20">
      <div className="relative bg-[#050810] py-12 lg:py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="animate-fade-up text-4xl lg:text-[64px] font-light text-white tracking-[-0.03em] leading-[0.95]">Privacybeleid</h1>
        </div>
      </div>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="animate-fade-up space-y-8">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Welke gegevens verzamelen wij?</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Waarvoor gebruiken wij je gegevens?</h2>
            <ul className="list-disc pl-6 text-slate-600 dark:text-slate-300 space-y-2">
              ...
              <li>Het verwerken van contactformulieren en nieuwsbriefaanmeldingen</li>
            </ul>
          </div>
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Verwerkers en diensten van derden</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Bewaartermijn</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Je rechten</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
