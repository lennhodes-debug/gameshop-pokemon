...
function NoiseOverlay() {
  return (
    <svg
      className="pointer-events-none fixed inset-0 z-[200] h-full w-full opacity-[0.04]"
      aria-hidden
    >
  ...
  return (
    <div ref={containerRef} className="relative h-[300vh]">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden bg-[#050810]">
        ...
        <motion.div style={{ x }} className="flex gap-16 lg:gap-24 px-[10vw] will-change-transform">
          {/* Intro card */}
          <div className="flex-shrink-0 w-[90vw] sm:w-[60vw] lg:w-[40vw] flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-lg text-slate-400 leading-relaxed max-w-md">
                Vijf principes die elk product, elke interactie en elke beslissing bij Gameshop
                Enter vormgeven.
              </p>
            </motion.div>
          </div>
            ...
            >
              <div className="relative group">
                ...
                <div className="relative bg-white/[0.04] backdrop-blur-sm border border-white/[0.04] rounded-3xl p-10 lg:p-14">
                  ...
                  <p className="text-slate-400 text-lg leading-relaxed">{val.sub}</p>
                </div>
              </div>
            </motion.div>
          ))}
...
const timeline = [
  {
    ...
    description:
      'Op mijn 14e begon ik met het verkopen van games en verzamelkaarten op Marktplaats. Nintendo DS, Game Boy, alles. Wat begon als zakgeld verdienen, werd een echte passie.',
    color: 'from-violet-500 to-purple-600',
  },
  {
    year: '2019',
    title: 'Vallen en opstaan',
    description:
      'Ik waagde me aan iPhones en PlayStation consoles. Werd meerdere keren opgelicht. Harde lessen — maar ze leerden me alles over vertrouwen en kwaliteitscontrole.',
    color: 'from-slate-500 to-slate-700',
  },
  {
    year: '2020',
    title: 'Terug naar de passie',
    description:
      'Na de tegenslagen terug naar mijn roots: Nintendo. Originele games inkopen, testen en met zorg doorverkopen. Focus op kwaliteit boven kwantiteit.',
    color: 'from-amber-500 to-orange-600',
  },
  {
    year: '2022',
    title: 'Gameshop Enter',
    description:
      'Tijd voor een echte naam. Gameshop Enter werd opgericht als dé plek voor originele, geteste Nintendo games met eerlijke prijzen.',
    color: 'from-emerald-500 to-teal-600',
  },
  {
    year: '2023',
    title: 'Studie & praktijk',
    description:
      'Start studie Ondernemerschap en Retailmanagement aan het Saxion. Elke les direct toepasbaar op de webshop.',
  ...
  },
  {
    ...
    description:
      'Meer dan 3000 blije klanten en 1360+ reviews met een perfecte 5.0 score op Marktplaats. De groei gaat door.',
    color: 'from-amber-400 to-yellow-500',
  },
  {
    year: 'Nu',
    title: 'Dé gaming specialist',
    description:
      'Gameshop Enter is dé retro gaming specialist van Nederland. Originele games, eigen fotografie, persoonlijke service — van Game Boy tot Switch.',
    ...
    <div className="h-[32vh] lg:h-[36vh] sticky" style={{ top: `${100 + index * 25}px` }}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-end h-full">
          ...
          <p className="text-white/80 text-sm lg:text-base leading-relaxed max-w-lg">
            {item.description}
          </p>
        </div>
      </motion.div>
...
function PerspectiveQuote() {
  ...
  return (
    <section ref={quoteRef} className="relative py-32 lg:py-44 overflow-hidden">
      ...
      <div className="absolute top-[12%] left-[6%] text-[200px] lg:text-[280px] font-serif text-emerald-500/[0.03] select-none leading-none pointer-events-none">
        &ldquo;
      </div>
      <div className="absolute bottom-[12%] right-[6%] text-[200px] lg:text-[280px] font-serif text-emerald-500/[0.03] select-none leading-none pointer-events-none">
        &rdquo;
      </div>
...
function CursorSpotlight() {
  ...
  const dimText =
    'Een webshop met games. Niets bijzonders, toch? Gewoon een plek waar je Nintendo games koopt. Net als honderd andere winkels online.';
  const revealText =
    'Wij zijn anders. Elke game persoonlijk geselecteerd, gecontroleerd op originaliteit, getest en met eigen fotografie vastgelegd. Geen anonieme webshop — een specialist die je bij naam kent.';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            transition={
              isHovered ? { duration: 0.2 } : { duration: 2, repeat: Infinity, ease: 'easeInOut' }
            }
          >
...
const processSteps = [
  {
    num: '01',
    title: 'Selectie',
    desc: 'Zorgvuldig zoeken naar originele games bij betrouwbare bronnen',
  ...
  },
  {
    num: '02',
    title: 'Authenticatie',
    desc: 'Elke game gecontroleerd op originaliteit — geen reproducties',
  ...
  },
  {
    num: '03',
    title: 'Testen',
    desc: 'Persoonlijk getest op werking — save, batterij, connectie',
  ...
  },
  {
    num: '04',
    title: 'Fotografie',
    desc: "Eigen productfoto's — wat je ziet is wat je krijgt",
  ...
  },
  {
    ...
    icon: 'M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0H21M3.375 14.25h.008M21 12.75h-2.25A2.25 2.25 0 0016.5 15v.75',
    ...
    <div className="pt-16 lg:pt-20">
      ...
      >
        ...
        >
          ...
          >
            Het eerlijke verhaal van Lenn Hodes &mdash; van harde lessen op Marktplaats tot een
            webshop met 3000+ tevreden klanten.
          </motion.p>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
        ...
        >
          Hoi, ik ben{' '}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-600 font-semibold">
            Lenn
          </span>
          .
        </motion.h2>
        ...
        >
          ...
          <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[120px] leading-none font-serif text-slate-100 select-none pointer-events-none">
            &ldquo;
          </span>
                ...
                <div className="relative bg-white rounded-2xl p-6 lg:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div
                        className={`h-12 w-12 rounded-xl bg-gradient-to-br ${step.gradient} flex items-center justify-center text-white shadow-lg flex-shrink-0 group-hover:scale-110 transition-transform duration-500`}
                      >
                        <svg
                          className="h-6 w-6"
                          fill="none"
            ...
            >
              <div className="group relative h-full bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-2xl p-8 lg:p-10 hover:from-emerald-500/15 hover:to-cyan-500/15 transition-all duration-500 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl lg:text-3xl font-semibold text-white mb-3 tracking-tight">
                    100% Origineel
                  </h3>
                  <p className="text-base lg:text-lg text-slate-300 leading-relaxed max-w-md">
                    Elke game wordt gecontroleerd op authenticiteit. Geen reproducties, geen namaak.
                    Gegarandeerd origineel &mdash; dat is onze belofte.
                  </p>
                  <div className="mt-8 flex items-center gap-3">
                    <div className="h-2 w-2 rounded-full bg-emerald-400" />
                    <span className="text-xs font-medium text-emerald-400 uppercase tracking-[0.15em]">
                      Gegarandeerd
                    </span>
                  </div>
                </div>
            ...
            {[
              {
                ...
                desc: 'Elk product handmatig getest. Werkt het niet? Dan verkopen we het niet.',
              ...
              },
              {
                ...
                desc: "Wat je ziet is wat je krijgt. Geen stock foto's.",
                gradient: 'from-amber-400 to-orange-400',
                icon: 'M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z',
              },
              {
                title: 'Veilig betalen',
                desc: 'iDEAL, geen extra kosten.',
                gradient: 'from-violet-400 to-purple-400',
                icon: 'M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z',
              },
              {
                title: 'Snelle verzending',
                desc: 'PostNL, volgende werkdag. Gratis boven €100.',
              ...
              >
                <div className="group relative h-full bg-white/[0.03] rounded-2xl p-6 hover:bg-white/[0.06] transition-all duration-500 hover:scale-[1.02]">
                  <div
                    className={`h-10 w-10 rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-white mb-4 shadow-lg`}
                  >
                    <svg
                      className="h-5 w-5"
                      fill="none"
        ...
        <div className="relative">
          ...
          <div className="flex gap-5 mb-5 animate-marquee" style={{ width: 'max-content' }}>
            {[
              {
                name: 'Mark V.',
                text: "Snelle levering, perfect verpakt. Precies wat ik verwachtte op basis van de foto's. Topservice!",
                product: 'Pokémon HeartGold',
              },
              {
                name: 'Sanne K.',
                text: 'Eindelijk een betrouwbare verkoper voor retro games. Alles origineel, netjes getest en supersnel geleverd.',
                product: 'Mario Kart DS',
              },
              {
                name: 'Thomas B.',
                text: 'De mooiste Nintendo collectie online. Lenn reageert snel op vragen en de verpakking was echt top!',
                product: 'Pokémon Emerald',
              },
              {
                name: 'Emma L.',
                text: 'Binnen 24 uur geleverd, game werkt perfect. Echt een aanrader voor iedereen die originele games zoekt.',
                product: 'Pokémon Platinum',
              },
              {
                name: 'Daan W.',
                text: 'Mijn zoon was dolblij. Alles keurig verpakt en precies zoals beschreven. Dankjewel Lenn!',
                product: 'Pokémon White',
              },
              {
                name: 'Lisa M.',
                text: "Al meerdere keren besteld, altijd perfect. De foto's kloppen precies met wat je ontvangt.",
                product: 'Pokémon SoulSilver',
              },
              {
                name: 'Mark V.',
                text: "Snelle levering, perfect verpakt. Precies wat ik verwachtte op basis van de foto's. Topservice!",
          ...
          <div className="flex gap-5 animate-marquee-reverse" style={{ width: 'max-content' }}>
            {[
              {
                name: 'Jasper H.',
                text: "Fantastische service! Game was compleet in doos met handleiding. Precies zoals de foto's lieten zien.",
                product: 'Pokémon Black 2',
              },
              {
                name: 'Nina R.',
                text: 'Ik zoek altijd naar originele games en bij Gameshop Enter weet ik zeker dat het klopt. Aanrader!',
                product: 'Mario & Luigi',
              },
              {
                name: 'Bram J.',
                text: 'Razendsnelle levering en heel netjes verpakt. Mijn DS game werkt als een zonnetje. Top!',
                product: 'Zelda Spirit Tracks',
              },
              {
                name: 'Sophie V.',
                text: 'Lenn denkt echt mee. Had een vraag over een game en kreeg binnen een uur uitgebreid antwoord.',
                product: 'Animal Crossing',
              },
              {
                name: 'Rick P.',
                text: 'Na jarenlang zoeken eindelijk een betrouwbare plek voor retro Nintendo. Wordt vaste klant!',
                product: 'Pokémon Diamond',
              },
              {
                name: 'Fleur D.',
                text: 'Cadeautje voor mijn broer, perfect aangekomen. De verpakking was echt met zorg gedaan.',
                product: 'New Super Mario Bros',
              },
              {
                name: 'Jasper H.',
                text: "Fantastische service! Game was compleet in doos met handleiding. Precies zoals de foto's lieten zien.",
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-400 max-w-md mb-12">
              De feiten op een rij &mdash; transparant en eerlijk, zoals alles wat we doen.
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                {
                  label: 'Specialisatie',
                  value: 'Originele Nintendo games',
                  ...
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-400 flex items-center justify-center text-white mb-4 shadow-lg">
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0H21M3.375 14.25h.008M21 12.75h-2.25A2.25 2.25 0 0016.5 15v.75"
                      />
                    </svg>
                  </div>
                  <dt className="text-xs font-medium text-emerald-400/70 uppercase tracking-wider mb-1">
                    Verzending
                  </dt>
                  <dd className="text-white font-semibold text-lg">
                    PostNL &mdash; volgende werkdag
                  </dd>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white/[0.03] p-6 hover:bg-white/[0.05] transition-all duration-500">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Bijna nieuw &mdash; minimale tot geen gebruikssporen. Het product ziet er
                    vrijwel ongebruikt uit en functioneert perfect.
                  </p>
                </div>
                <div className="rounded-2xl bg-white/[0.03] p-6 hover:bg-white/[0.05] transition-all duration-500">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Tweedehands &mdash; normale gebruikssporen aanwezig. Het product is volledig
                    getest op werking en functioneert naar behoren.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-400 mb-14 max-w-lg mx-auto leading-relaxed">
              Elke game in onze collectie is persoonlijk getest, gefotografeerd en klaar om bij jou
              thuis te komen.
            </p>
