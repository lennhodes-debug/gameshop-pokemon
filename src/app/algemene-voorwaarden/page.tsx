    ...
    <div className="pt-20 lg:pt-24">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Artikel 2 - Prijzen en betaling</h2>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Artikel 3 - Verzending</h2>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-4">Artikel 4 - Herroepingsrecht</h2>
            <p className="text-slate-600 leading-relaxed">
