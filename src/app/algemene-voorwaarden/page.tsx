    ...
    <div className="pt-20 lg:pt-24">
      <div className="relative bg-[#050810] py-12 lg:py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="animate-fade-up text-3xl lg:text-5xl font-semibold text-white tracking-tight">Algemene voorwaarden</h1>
        </div>
      </div>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="animate-fade-up space-y-8">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Artikel 2 - Prijzen en betaling</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Artikel 4 - Herroepingsrecht</h2>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
