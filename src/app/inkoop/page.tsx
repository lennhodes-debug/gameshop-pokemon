              ...
              {submitted ? (
                ...
                >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      <label htmlFor="inkoop-beschrijving" className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Welke Pok&eacute;mon games wil je verkopen? *</label>
                      <textarea
                        ...
                        placeholder="Beschrijf hier welke Pok&eacute;mon games je wilt verkopen. Vermeld ook de staat (nieuw, gebruikt, beschadigd) en of je de originele doos en handleiding nog hebt."
                      />
                    </div>
                    ...
                    <div className="bg-amber-50/60 dark:bg-amber-950/20 rounded-xl px-4 py-3 border border-amber-200/60 dark:border-amber-800/40">
                      <div className="flex items-start gap-2.5">
                        ...
                        <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                          <span className="font-semibold text-slate-700 dark:text-white">Tip:</span> Na het verzenden opent je e-mail app. Voeg daar foto&apos;s toe van de voorkant, achterkant en eventuele doos. Duidelijke foto&apos;s helpen ons een beter bod te doen!
                        </p>
                      </div>
                    </div>
