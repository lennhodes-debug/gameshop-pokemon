...
export const metadata: Metadata = {
  ...
  description: 'Het retourbeleid van Gameshop Enter. 14 dagen bedenktijd op alle Nintendo games. Gratis retourneren, geen vragen. Lees hier hoe retourneren werkt.',
  alternates: { canonical: 'https://gameshopenter.nl/retourbeleid' },
  openGraph: {
    title: 'Retourbeleid - Gameshop Enter',
    description: '14 dagen bedenktijd op alle Nintendo games. Gratis retourneren bij Gameshop Enter.',
