...
export const metadata: Metadata = {
  ...
  description: 'Bekijk ons complete assortiment van 140+ originele Nintendo producten. Van Game Boy tot Wii U, alles persoonlijk getest. Veilig bestellen bij Gameshop Enter.',
  ...
  openGraph: {
    ...
    description: '140+ originele Nintendo producten. Van Game Boy tot Wii U, alles persoonlijk getest.',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: '140+ originele Nintendo producten van Game Boy tot Wii U.',
            url: 'https://gameshopenter.nl/shop',
            isPartOf: {
              '@type': 'WebSite',
              name: 'Gameshop Enter',
