                        ...
                        <div className="flex items-center justify-between mt-3">
                          <div className="flex items-center gap-2">
                            ...
                            <motion.button
                              whileTap={{ scale: 0.9 }}
                              onClick={() => {
                                addToWishlist(item.product.sku);
                                removeItem(key);
                                addToast(`${item.product.name} bewaard op verlanglijst`, 'success');
                              }}
                              aria-label={`${item.product.name} bewaren voor later`}
                              className={`ml-2 p-1.5 rounded-lg transition-all ${isInWishlist(item.product.sku) ? 'text-red-400' : 'text-slate-400 dark:text-slate-500 hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20'}`}
                              title="Bewaar voor later"
                            >
                              <svg className="h-4 w-4" viewBox="0 0 24 24" fill={isInWishlist(item.product.sku) ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={2}>
                            ...
                            <motion.button
                              ...
                              className="p-1.5 rounded-lg text-slate-400 dark:text-slate-500 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all"
                            >
                              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
