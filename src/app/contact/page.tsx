    ...
    <div className="pt-20 lg:pt-24">
      ...
      <div className="relative bg-[#050810] py-20 lg:py-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <nav className="flex items-center justify-center gap-2 text-sm text-slate-400 mb-6" aria-label="Breadcrumb">
            ...
            <span className="text-slate-200 font-medium">Contact</span>
          </nav>
          <motion.div
            initial="hidden"
            animate="visible"
