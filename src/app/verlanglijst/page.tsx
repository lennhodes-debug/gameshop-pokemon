      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        {products.length === 0 ? (
          ...
          >
            ...
            <h2 className="text-xl font-semibold text-slate-900 mb-2">Je verlanglijst is leeg</h2>
            <p className="text-slate-500 mb-6">Klik op het hartje bij een product om het op te slaan.</p>
            <Link
              href="/shop"
          ...
          <>
            ...
            >
              ...
              <button
                onClick={handleShare}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white border border-slate-200 text-sm font-semibold text-slate-700 hover:border-emerald-300 hover:text-emerald-600 transition-all"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-red-500 hover:bg-red-50 transition-all"
              >
                Alles verwijderen
              </button>
            </motion.div>
                  ...
                  return (
                    ...
                    >
                      <Link href={`/shop/${product.sku}`} className="flex gap-4 p-4">
                        {/* Image */}
                        <div className="h-20 w-20 rounded-xl bg-slate-50 overflow-hidden flex-shrink-0">
                          {product.image ? (
                            <Image
                              src={product.image}
                              alt={product.name}
                            ...
                            <span className="h-full w-full flex items-center justify-center text-xs font-semibold text-slate-300">
                              {platformLabel}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-semibold text-slate-900 line-clamp-2 group-hover:text-emerald-600 transition-colors">
                            {product.name}
                          </p>
                      ...
                      <div className="flex border-t border-slate-100">
                        <button
                          ...
                          className="flex-1 py-2.5 text-xs font-semibold text-emerald-600 hover:bg-emerald-50 transition-colors flex items-center justify-center gap-1.5"
                        >
                        ...
                        <button
                          ...
                          className="px-4 py-2.5 text-xs font-semibold text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors"
